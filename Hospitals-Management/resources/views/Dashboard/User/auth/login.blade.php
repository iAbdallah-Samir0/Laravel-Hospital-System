										...
										<div class="card-sigin">
											<div class="main-signup-header">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select class="form-control" id="sectonchooser">
                                                        <option value="" selected disabled>{{trans('Dashboard/login_trans.Choose_From_Menu')}}</option>
                                                ...
                                                <div class="loginform" id="admin">
                                                    ...
                                                    <form method="POST" action="{{ route('login.admin') }}">
                                                        @csrf
                                                        <div class="form-group">
                                                            <label>Email</label> <input class="form-control" placeholder="Enter your email" name="email" :value="old('email')" required autofocus>
                                                        </div>
                                                        <div class="form-group">
                                                            <label>Password</label> <input class="form-control" placeholder="Enter your password" type="password" name="password" required autocomplete="current-password">
                                                        </div><button type="submit" class="btn btn-main-primary btn-block">Sign In</button>
